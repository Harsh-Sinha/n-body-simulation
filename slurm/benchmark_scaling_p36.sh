...
./install/bin/b_hut -t 0.1 -l 1 -in particle_ten_thousand.txt -out ten_thousand_p36 -p
./install/bin/b_hut -t 0.1 -l 1 -in particle_hundred_thousand.txt -out hundred_thousand_p36 -p
./install/bin/b_hut -t 0.1 -l 1 -in particle_five_hundred_thousand.txt -out five_hundred_thousand_p36 -p
./install/bin/b_hut -t 0.1 -l 1 -in particle_million.txt -out million_p36 -p
