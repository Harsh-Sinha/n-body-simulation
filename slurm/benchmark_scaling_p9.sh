...
./../install/bin/b_hut -t 0.1 -l 1 -in particle_ten_thousand_p9.txt -out ten_thousand_p9 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_hundred_thousand_p9.txt -out hundred_thousand_p9 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_five_hundred_thousand_p9.txt -out five_hundred_thousand_p9 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_million_p9.txt -out million_p9 -p
