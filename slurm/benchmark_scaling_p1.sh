...
./../install/bin/b_hut -t 0.1 -l 1 -in particle_ten_thousand_p1.txt -out ten_thousand_p1 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_hundred_thousand_p1.txt -out hundred_thousand_p1 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_five_hundred_thousand_p1.txt -out five_hundred_thousand_p1 -p
./../install/bin/b_hut -t 0.1 -l 1 -in particle_million_p1.txt -out million_p1 -p
